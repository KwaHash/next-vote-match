export const parties = [
  ...
  { id: 3, value: '日本維新', label: '日本維新' },
  { id: 4, value: '国民民主党', label: '国民民主党' },
  { id: 5, value: '共産党', label: '共産党' },
  { id: 6, value: 'れいわ新選', label: 'れいわ新選' },
  { id: 7, value: '減ゆ連', label: '減ゆ連' },
  { id: 8, value: '参政党', label: '参政党' },
  { id: 9, value: '日本保守党', label: '日本保守党' },
  { id: 10, value: '社民党', label: '社民党' },
  { id: 11, value: 'みらい', label: 'みらい' },
